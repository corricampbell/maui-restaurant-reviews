...
import com.mauirestaurantreviews.mauirestaurantreviews.Review;
import com.mauirestaurantreviews.mauirestaurantreviews.ReviewRepository;
...
public class ReviewRepositoryTest {
	...
	private Review firstReview = new Review(firstReviewId, "review name", "description", "body", "picture");
	
	private long secondReviewId = 2L;
	private Review secondReview = new Review(secondReviewId, "review name", "description", "body", "picture");
